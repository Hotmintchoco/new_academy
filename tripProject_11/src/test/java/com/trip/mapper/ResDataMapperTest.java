...
@Log4j
public class ResDataMapperTest {
	@Autowired
	...
	public void testInsert() throws IOException {
        try {
			Document doc = Jsoup.connect("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList"
					+ "?serviceKey=sWi23NfHCswD2JLkVzlAjWdx84T9hH%2B4%2BgYdeHg5rakMR397CZtjr1hoq8Mo56LMzSCjxrlMzLEkI0Bi%2FwFQ0Q%3D%3D&pageNo=1&numOfRows=2630&MobileApp=AppTest&MobileOS=ETC&arrange=B&cat1=&contentTypeId=39&listYN=Y").get();
